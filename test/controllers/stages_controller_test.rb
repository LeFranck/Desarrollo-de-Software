...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { completed: @stage.completed, description: @stage.description, video_link: @stage.video_link }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { completed: @stage.completed, description: @stage.description, video_link: @stage.video_link }
    assert_redirected_to stage_path(assigns(:stage))
  end
